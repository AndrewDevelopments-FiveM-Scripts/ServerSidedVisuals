...
updatePath = "/AndrewTheWusky/versionChecker/blob/main/versionCheck/ServerSideVisuals_Version"
resourceName = "ServerSidedVisuals ("..GetCurrentResourceName()..")"

function checkVersion(err,responseText, headers)
	curVersion = LoadResourceFile(GetCurrentResourceName(), "SSVVersion")
